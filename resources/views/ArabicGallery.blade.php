    ...
    <section class="f-cairo">
        ...
        <section class="mt-5 py-5" style="background-color:#323031">
            ...
            <div class="d-flex align-items-center justify-content-center">
                <a href="https://www.instagram.com/tacosfoxuae/" target="_blank" class="d-flex align-items-center gap-2"
                    style="background-color: #408BD1; padding: 5px 8px; margin: 20px 0 0 0; border-radius: 4px">
                    <img src="{{ asset('Assets/Icons/instagram.png') }}">
