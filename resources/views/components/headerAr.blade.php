                ...
                <div class="container-fluid d-flex align-items-center justify-content-between pe-3 text-white">
                    ...
                    <div class="collapse navbar-collapse " dir="rtl" id="navbarNavDropdown">
                        <ul class="navbar-nav ms-auto">
                            <x-nav-website-link :href="route('home-ar')" :active="request()->routeIs('home-ar')">الصفحة الئيسية</x-nav-website-link>
                            <x-nav-website-link :href="route('gallery-ar')" :active="request()->routeIs('gallery-ar')">المعرض</x-nav-website-link>
                            <x-nav-website-link :href="route('menu-ar')" :active="request()->routeIs('menu-ar')">المنيو</x-nav-website-link>
                            <x-nav-website-link :href="route('contact-ar')" :active="request()->routeIs('contact-ar')">تواصل معنا</x-nav-website-link>
                            ...
                            <img class="mx-2 my-auto " id="search-icon" src="{{ asset('Assets/search.png') }}"
